export function delFromLocalStorage(name: string,value: string): void{
...
export function getEmployeeData():employeeDataObjectType[]{
...
export type employeeDataObjectType =  {
    user: string;
    firstName: string;
    lastName: string;
    location: string;
